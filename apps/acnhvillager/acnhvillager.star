            ...
            child=render.Row(
                ...
                children=[
                    # Left column - Name and Icon
                            render.Column(
                                ...
                                children=[
                                    render.Marquee(
                                        child=render.Text(
                                            content=get_villager_name(
                                                villager["name"][name_key]),
                                            font=FONT_DEFAULT,
                    ...
                    render.Column(
                                ...
                                children=[
                                    render.WrappedText(
                                        # Shouldn't go over 6 characters
                                        content=villager["personality"],
                                        font=FONT_DEFAULT,
                                        width=28,
                                        align="right",
                                    ),
                                    ...
                                    render.Marquee(
                                        child=render.Text(
                                            content=get_villager_catch_phrase(
                                                villager["catch-translations"][catch_phrase_key]),
                                            font=FONT_DEFAULT,
...
def get_villager_data():
    ...
    if villager_data_cached != None:
        ...
        cache.set("villager_data", json.encode(
            villager_data), ttl_seconds=CACHE_TTL_SECONDS)
